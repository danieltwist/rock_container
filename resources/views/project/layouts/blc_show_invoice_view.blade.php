...
<div class="row invoice-info">
    <div class="col-sm-6 invoice-col">
        ...
        @endif
        @if ($invoice->agree_1 != '')
            <b>{{ __('invoice.agreement') }}:</b> @include('invoice.status_switch', ['status' => unserialize($invoice->agree_1)['status']]) {{ unserialize($invoice->agree_1)['date'] }}
        @endif

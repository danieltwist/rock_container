...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">{{ __('work_request.done_tasks') }}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header cursor-pointer" data-card-widget="collapse">
                            <h3 class="card-title">{{ __('work_request.all_done_work_requests_by_you') }}</h3>
                        </div>
                        <div class="card-body">
                            ...
                            @else
                                {{ __('work_request.dont_have_done_work_requests_by_you') }}
                            @endif
                        </div>
                    </div>
                </div>

<table class="table table-striped" id="containers_extended_ajax_table">
    <thead>
    <tr>
        <th class="text-sm" style="width: 5px;">#</th>
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 200px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 100px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 300px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 100px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>
        ...
        <th class="text-sm no-sort input-filter" style="width: 300px;"></th>
        <th class="text-sm no-sort input-filter" style="width: 200px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 300px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 300px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>
        ...
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>
        <th class="text-sm no-sort input-filter" style="width: 250px;"></th>
        <th class="text-sm no-sort input-filter" style="width: 150px;"></th>
        <th class="text-sm no-sort input-filter" style="width: 200px;"></th>
        <th class="text-sm no-sort input-filter" style="width: 200px;"></th>
        <th class="text-sm no-sort select-filter" style="width: 150px;"></th>

...
@section('title', __('report.credit'))
@section('content')
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1 class="m-0">{{ __('report.credit') }}</h1>
                    </div>
                </div>
            </div>
        </div>
        <section class="content">
            ...
            @include('layouts.info_block')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="invoices_debit_credit" data-type="credit">
                            @include('invoice.table.invoices_table_ajax_filter', ['filter' => 'credit'])
                        </div>
                    </div>
                    <div class="card-footer">
                        <form action="{{ route('invoices_export_with_filter_to_excel') }}" method="GET">
                            ...
                            @php
                                $parameters = [
                                    'filename' => 'кредиторская_задолженность',
                                    'sorting_type' => 'Кредиторская задолженность'
                                ];
                            @endphp
                            <input type="hidden" name="filter" value="credit">

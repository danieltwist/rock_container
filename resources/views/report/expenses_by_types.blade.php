...
@section('title', 'Сводка по расходам')
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Сводка по расходам</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">Скачать сводку по расходам</h3>
                        </div>
                        <form action="{{ route('get_report_expenses_by_types') }}" method="GET">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">

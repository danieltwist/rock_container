...
$clientId     = '3e8da1aae8b843d580b43add0bbf3102'; // ID приложения
$clientSecret = 'd8c9a45c44ff496fb0b7a8b144079fc9'; // Пароль приложения
$redirectUri  = 'https://rocklogistic-system.ru/yandex-oauth.php'; // Адрес, на который будет переадресован пользователь после прохождения авторизации
